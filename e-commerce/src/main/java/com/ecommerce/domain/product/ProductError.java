...
public class ProductError {
    ...
    public static Supplier<NotFoundException> supplyProductNotFound(final String fieldName, final Object fieldValue) {
        return () -> new NotFoundException("Product with %s %s cannot be found", fieldName, fieldValue);
    }

    public static Supplier<ConflictException> supplyProductExisted(final String fieldName, final Object fieldValue) {
